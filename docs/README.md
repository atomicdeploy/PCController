...
6. [C Library API](../Tools/Controller/docs/C-Library-API.md) — embedding the Go
   controller through its C-compatible DLL.
7. [Memory and Feature Tradeoffs](Memory-and-Feature-Tradeoffs.md) — measured
   AVR flash/SRAM use and the exact capability lost by each optional cut.
8. [Local Library Merge History](Local-Library-Merge-History.md) — what differed
