...
var protocolMenuPages = []MenuPageInfo{
	...
	{4, "temperature-bt", "t-bt", "BT Amplifier temperature", "BT-5.0-Pro amplifier temperature sensor"},
...
var voltageFirstMenuPages = []MenuPageInfo{
	...
	{3, "temperature-bt", "t-bt", "BT Amplifier temperature", "BT-5.0-Pro amplifier temperature sensor"},
