...
func TestCanonicalRESTRouteInventory(t *testing.T) {
	...
	routes := []struct {
		...
		{name: "board name", method: http.MethodGet, path: "/api/board/name"},
		{name: "board name mutation", method: http.MethodPut, path: "/api/board/name", body: `{"name":"CAFE"}`},
		{name: "board name clear", method: http.MethodDelete, path: "/api/board/name"},
