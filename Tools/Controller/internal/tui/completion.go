...
var nestedCompletions = map[string][]string{
	...
	"macro":              {"list", "show", "create", "update", "rename", "category", "delete", "record", "play", "status", "monitor", "cancel"},
	"macro record":       {"start", "board", "status", "save", "stop", "discard"},
	"macro record board": {"start", "stop", "clear", "status"},
	"automation":         {"list", "run"},
	...
	"board":              {"initialize", "provision", "blank", "name"},
	"board initialize":   {"--skip-toolchain", "--portable-cli", "--fqbn="},
	"board provision":    {"--name=", "--uart=auto", "--uart=none", "--firmware=", "--force-initialize", "--skip-toolchain"},
