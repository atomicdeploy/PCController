...
var nestedCompletions = map[string][]string{
	...
	"program compile":   {".", "--firmware-feature=eeprom-boot-opcodes", "--firmware-feature=eeprom-menu-labels", "--no-firmware-features"},
	"toolchain":         {"bootstrap", "sync", "profile", "features", "compile", "core-info", "install-bootloader"},
	"toolchain compile": {".", "--firmware-feature=eeprom-boot-opcodes", "--firmware-feature=eeprom-menu-labels", "--no-firmware-features"},
	"board":             {"initialize", "name"},
	"board initialize":  {"--name=", "--uart=auto", "--uart=none", "--firmware-feature=eeprom-boot-opcodes", "--firmware-feature=eeprom-menu-labels", "--no-firmware-features", "--bootloader-only", "--skip-toolchain"},
