...
func (model Model) buildAppSettingEditor(editor *settingEditor) {
	...
	case "measurement.freshness":
		editor.Fields = []settingEditorField{{Key: "window", Label: "Freshness window", Value: ui.MeasurementFreshnessMS, Options: intOptions([]int{500, 750, 1000, 1500, 2000, 3000, 5000}, "ms")}}
