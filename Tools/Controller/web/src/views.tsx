    ...
    <>
      ...
      <section className={`hero-panel${snapshot.connected ? ' is-online' : ''}`}>
        <div className="hero-panel__identity">
          ...
          <h2><a href={authenticationRequired ? '#/settings' : '#/dashboard'}>{snapshot.connected ? snapshot.hello.name || appTitle : t(authenticationRequired ? 'authenticationDashboard' : 'noHardware')}</a></h2>
