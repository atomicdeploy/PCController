...
export const messages = {
  en: {
    ...
    noHardware: 'Controller offline — the host is waiting for the board.',
    hostUnavailableDashboard: 'Host connection unavailable — check the connection details below.',
    hostUnavailableDashboardDetail: 'Restore the host connection to resume live board state and telemetry.',
    connectionPausedDashboard: 'Controller connection paused.',
  ...
  fa: {
    ...
    noHardware: 'کنترلر آفلاین است — میزبان در انتظار برد است.',
    hostUnavailableDashboard: 'اتصال میزبان در دسترس نیست — جزئیات اتصال را در ادامه بررسی کنید.',
    hostUnavailableDashboardDetail: 'برای ادامهٔ دریافت وضعیت زندهٔ برد و تله‌متری، اتصال میزبان را بازیابی کنید.',
    connectionPausedDashboard: 'اتصال کنترلر متوقف شده است.',
