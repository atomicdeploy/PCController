...
export const messages = {
  en: {
    ...
    authenticationRequired: 'Authentication required', enterSessionToken: 'Enter session token',
  ...
  fa: {
    ...
    authenticationRequired: 'احراز هویت لازم است', enterSessionToken: 'ورود توکن نشست',
