...
const capabilityGroups = {
  ...
  board_commands: [
	...
	"controller.board.name.set", "controller.board-name.set",
...
const methodOverrides = {
  ...
  "controller.snapshot": "Return the authoritative cached controller snapshot.",
	"controller.board.name.get": "Read the operator-assigned CRC-backed EEPROM board name.",
	"controller.board.name.set": "Persist and independently verify an operator board name of up to eight printable ASCII characters.",
	"controller.board.name.clear": "Clear and independently verify the persistent operator board name.",
...
const routes = [
  ...
  { path: "/api/snapshot", methods: ["get"], capability: "read", summary: "Authoritative cached controller snapshot" },
	{ path: "/api/board/name", methods: ["get"], capability: "read", summary: "CRC-backed operator board name" },
	{ path: "/api/board/name", methods: ["put", "delete"], capability: "board_commands", summary: "Persist, verify, or clear the operator board name" },
